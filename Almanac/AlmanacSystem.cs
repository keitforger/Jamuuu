...
public class AlmanacSystem : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (jamuDatabase == null)
        {
            ...
            if (jamuDatabase == null)
                Debug.LogError("AlmanacSystem: Tidak bisa load JamuDatabase dari Resources/eJamuuu/JamuDatabase.asset");
            else
                Debug.Log("AlmanacSystem: Berhasil load JamuDatabase dari Resources/eJamuuu/JamuDatabase.asset");
        }
